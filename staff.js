    ...
    <div id="custom-alert-modal" class="modal-overlay" style="z-index: 3000; display: none;">
        <div class="modal-content" style="max-width: 400px; text-align: center;">
            ...
            <div class="modal-body" style="padding-top: 10px;">
                ...
                <button id="custom-alert-ok-btn" class="save-btn" style="width: auto; padding: 10px 40px; margin-top:0;">OK</button>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content" style="max-width: 400px; text-align: center;">
            ...
            <div class="modal-body" style="padding-top: 10px;">
                ...
                <div style="display: flex; gap: 15px; justify-content: center;">
                    <button id="custom-confirm-cancel-btn" class="save-btn" style="background: #ef4444; width: auto; padding: 10px 30px; margin-top:0;">Cancel</button>
                    <button id="custom-confirm-yes-btn" class="save-btn" style="width: auto; padding: 10px 30px; margin-top:0;">Yes</button>
                </div>
            </div>
        </div>
    </div>
...
window.switchView = function(viewId) {
    ...
    else if (viewId.includes('attendance')) document.getElementById('nav-attendance').classList.add('active');

    // NEW: Close sidebar on mobile selection
