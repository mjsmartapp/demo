...
window.addEventListener('load', async () => {
    injectCustomModals();
    injectSidebarFooter(); // NEW: Inject Sidebar Footer for Mobile
...
// --- SIDEBAR FOOTER LOGIC (MOBILE ONLY) ---
function injectSidebarFooter() {
    ...
    const footerHTML = `
        <div class="sidebar-footer">
            <p>SSVMS Admin Portal</p>
            <p style="font-size: 0.7rem; opacity: 0.6;">© 2026 Mobile View</p>
        </div>
    `;
    sidebar.insertAdjacentHTML('beforeend', footerHTML);

    // Inject CSS for visibility control
